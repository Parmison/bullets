...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_q:
                bullet = Bullet(yellow.rect.x+100,yellow.rect.y + yellow.rect.height/2+50,"yellow")
                yellow_bullets.add(bullet)
            if event.key == pygame.K_p:
                bullet = Bullet(orange.rect.x,orange.rect.y + orange.rect.height/2+50,"orange")
                orange_bullets.add(bullet)
    ...
    handel_collision(yellow,orange,yellow_bullets,orange_bullets)